...
abstract class Assignment{
    ...
    protected void constuctData(string name, string topicInput){
        studentName = name;
        topic = topicInput;
    }
...
class Math:Assignment{
    public string textbookSelection {
        get;
        private set;
    }
    ...
    public Math(string name, string topic, 
    string textbook, string problem){
        constuctData(name, topic);
        textbookSelection = textbook;
        problems = problem;
    }

    public string GetHomeworkList(){
        return $"{textbookSelection} {problems}";
    }
}
...
class Writing:Assignment{
    ...
    public Writing(string assignTitle, string name, string topic){
        constuctData(name, topic);
        title = assignTitle;
    }
...
class RunAssignment:functionClass{
    ...
    protected override void runNoFlag(){
        // create a new instances of each class
        Math math = new Math("Jim", "Physics", "1A", "24-60");

        Writing writing = new Writing("The Causes of World War II by Mary Waters",
        "Mary Waters", "European History");
        
        Program.print("Math Summery:");
        Program.print(math.GetSummery());

        Program.print();
        Program.print("Math Homework:");
        Program.print(math.GetHomeworkList());

        Program.print();
        Program.print("Writing summery:");
        Program.print(writing.GetSummery());

        Program.print();
        Program.print("Writing title: ");
        Program.print(writing.title);
